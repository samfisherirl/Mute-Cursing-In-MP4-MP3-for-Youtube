...
def split_mp3(file_path):
    ...
    segment_duration = 60 * 60 * 1000  # 1 hour in milliseconds
    number_of_segments = math.ceil(duration_in_milliseconds / segment_duration)
    segment_paths = []

    for i in range(number_of_segments):
        start_time = i * segment_duration
        end_time = min((i + 1) * segment_duration, duration_in_milliseconds)
